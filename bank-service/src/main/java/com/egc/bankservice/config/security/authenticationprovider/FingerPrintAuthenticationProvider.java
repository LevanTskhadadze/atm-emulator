...
public class FingerPrintAuthenticationProvider implements AuthenticationProvider {
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		String fingerPrint = authentication.getCredentials().toString();
        ...
        if (passwordEncoder.matches(fingerPrint, authenticationDetails.getFingerPrint())) {
            return new FingerPrintAuthenticationToken(cardNumber, fingerPrint, new ArrayList<>());
        } else {
	...
	public boolean supports(Class<?> authentication) {
		return authentication.equals(FingerPrintAuthenticationToken.class);
	}
}
